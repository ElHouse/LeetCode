...
class _2047_Number_of_Valid_Words_in_a_SentenceTest {


    _2047_Number_of_Valid_Words_in_a_Sentence numberOfValidWordsInASentence = new _2047_Number_of_Valid_Words_in_a_Sentence();

    @Test
    public void countValidWords() {
        String sentence = "cat and  dog";
        assertEquals(3, numberOfValidWordsInASentence.countValidWords(sentence));
    }


    @Test
    public void countValidWords1() {
        String sentence = "!this  1-s b8d!";
        assertEquals(0, numberOfValidWordsInASentence.countValidWords(sentence));
    }

    @Test
    public void countValidWords2() {
        String sentence = "alice and  bob are playing stone-game10";
        assertEquals(5, numberOfValidWordsInASentence.countValidWords(sentence));
    }

    @Test
    public void countValidWords3() {
        String sentence = "alice1 and  bob are playing stone-game10 asjhkldasjkl, a-b-c a-b,";
        assertEquals(6, numberOfValidWordsInASentence.countValidWords(sentence));
    }

    @Test
    public void countValidWords4() {
        String sentence = "    ";
        assertEquals(0, numberOfValidWordsInASentence.countValidWords(sentence));
    }
    ...
    public void countValidWords6() {
        ...
        assertEquals(50, numberOfValidWordsInASentence.countValidWords(sentence));
    }
}